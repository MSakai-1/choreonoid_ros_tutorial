...
class ROSInferenceController : public SimpleController
{
    // ros変数追加
    ...
    // Command resampling
    Vector3d command;
    //Listing* lin_vel_x_range; //Listing*：yamlから読み取り
...
public:
    ...
    virtual bool initialize(SimpleControllerIO* io) override
    {
        ...
        // 追加
        subscriber = node->subscribe("cmd_vel", 1, &ROSInferenceController::command_velocity_callback, this);    return true;
...
CNOID_IMPLEMENT_SIMPLE_CONTROLLER_FACTORY(ROSInferenceController)
